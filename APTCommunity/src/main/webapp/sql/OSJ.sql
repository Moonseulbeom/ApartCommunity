...
CREATE TABLE MEMBER_DETAIL (
  ...
  CONSTRAINT FK_MEMBER_TO_MEMBER_DETAIL_1 FOREIGN KEY (MEM_NUM) REFERENCES MEMBER (MEM_NUM)
);
...
CREATE TABLE BOARD (
  ...
  CONSTRAINT FK_MEMBER_TO_BOARD_1 FOREIGN KEY (MEM_NUM) REFERENCES MEMBER (MEM_NUM)
);
...
CREATE TABLE BOOKING (
  ...
  CONSTRAINT FK_MEMBER_TO_BOOKING_2 FOREIGN KEY (MEM_NUM) REFERENCES MEMBER (MEM_NUM)
);
...
CREATE TABLE FIX (
  ...
  CONSTRAINT FK_MEMBER_TO_FIX_1 FOREIGN KEY (MEM_NUM) REFERENCES MEMBER (MEM_NUM)
);
...
CREATE TABLE FIX_REPLY (
  ...
  CONSTRAINT FK_MEMBER_TO_FIX_REPLY_1 FOREIGN KEY (MEM_NUM) REFERENCES MEMBER (MEM_NUM),
...
CREATE TABLE INQUIRY (
  ...
  CONSTRAINT FK_MEMBER_TO_INQUIRY_1 FOREIGN KEY (MEM_NUM) REFERENCES MEMBER (MEM_NUM)
);
...
CREATE TABLE INQUIRY_MANAGE (
  ...
  CONSTRAINT FK_MEMBER_TO_INQUIRY_MANAGE_2 FOREIGN KEY (MEM_NUM) REFERENCES MEMBER (MEM_NUM)
);
...
CREATE TABLE QUESTION (
  ...
  CONSTRAINT FK_MEMBER_TO_QUESTION_1 FOREIGN KEY (MEM_NUM) REFERENCES MEMBER (MEM_NUM)
);
...
CREATE TABLE SECONDHAND (
  ...
  CONSTRAINT FK_MEMBER_TO_SECONDHAND_1 FOREIGN KEY (MEM_NUM) REFERENCES MEMBER (MEM_NUM)
);
