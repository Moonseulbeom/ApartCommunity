					...
					<ul>
						...
						<li>
							<div class="page-right">
								<div class="detail">
									<input type="button" value="뒤로가기" onclick="location.href='seSaleList.do'" id="back"><br>
									<div class="detail-page">
										<div class="detail-page-title">
											<ul>
												<li>
													<a href="seSaleList.do">중고판매</a>
												</li>
												<li><b>${vo.title}</b></li>
												...
												<%-- user_num : 로그인한 회원번호 / vo.mem_num : 작성한 회원번호 --%>
													<input type="button" value="수정" onclick="location.href='seSaleUpdateForm.do?se_num=${vo.se_num}'">
