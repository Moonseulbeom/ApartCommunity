...
<div class="page-main">
	...
	<input type="button" value="뒤로가기" onclick="location.href='secondhandList.do'" id="back"><br>
		<h2>${vo.title}</h2>
		...
		<ul class="detail-sub">
			<li>
				<%-- 좋아요 --%>
				<img id="output_fav" data-num="${vo.se_num}" src="${pageContext.request.contextPath}/images/fav01.gif" width="50">
				좋아요
			...
			<li>
				...
				<c:if test="${user_num == vo.mem_num}">
					<%-- user_num : 로그인한 회원번호 --%>
					<%-- board.mem_num : 작성한 회원번호 --%>
					<input type="button" value="수정" onclick="location.href='updateForm.do?se_num=${vo.se_num}'">
					<%-- board.board_num : 해당글 번호 --%>
