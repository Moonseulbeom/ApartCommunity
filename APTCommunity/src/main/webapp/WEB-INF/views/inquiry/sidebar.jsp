...
<div class="sidebar">
	...
	<div class="menu">
		<ul>
			<li><a href="${pageContext.request.contextPath}/inquiry/list.do?dept=1">1:1 문의</a></li>
			<li><a href="${pageContext.request.contextPath}/question/list.do?dept=2">자주묻는 질문</a></li>
